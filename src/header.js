(() => {
  ...
  this.Header = function Header({
    ...
    const navButtonBox = new Box();
    buttonBox.add(navButtonBox);
    navButtonBox.get_style_context().add_class("linked");

    const backButton = Button.new_from_icon_name(
      "go-previous-symbolic",
      IconSize.BUTTON
    );
    navButtonBox.add(backButton);
    ...
    navButtonBox.add(forwardButton);
